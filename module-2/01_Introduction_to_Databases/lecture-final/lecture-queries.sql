...
-- All columns and data from the park table

SELECT * 
FROM park;

--better approach, more specific
...
SELECT city_name
FROM city
WHERE state_abbreviation = 'CA';-- where limits number of rows returned
...
FROM city
WHERE area < 25; --assuming column is in km squared
...
FROM park
WHERE area BETWEEN 100 AND 200; --inclusive
