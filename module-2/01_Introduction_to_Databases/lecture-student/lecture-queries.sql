...
SELECT 'Hell World' AS hello_world;
...
SELECT park_id, park_name, date_established, has_camping
FROM park;
...
SELECT city_name 
FROM city
WHERE state_abbreviation = 'CA';--limits number of rows returned
...
FROM park
WHERE area BETWEEN 100 AND 200; --IS INCLUSIVE
