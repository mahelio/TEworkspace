...
VALUES ('Mustafa Hilalani');

UPDATE movie SET director_id = (SELECT person_id FROM person WHERE person_name = 'Mustafa Hilalani') WHERE title = 'The Blob';

/*SELECT *
FROM person
WHERE person_id = 3984916; */